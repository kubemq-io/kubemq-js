...
- `pubsub\events\send-message-stream.ts` Demonstrates example of sending and receiving message using stream.
...
### Construct the EventsClient
 For executing PubSub operation we have to create the instance of EventsClient or EventsStoreClient, it's instance can created with minimum two parameter `address` (KubeMQ server address) & `clientId` . With these two parameter plainText connection are established. Below Table Describe the Parameters available for establishing connection.
### EventsClient Accepted Configuration
...
### EventsClient & EventStoreClient connection establishment example code
...
```typescript
ServerInfo pingResult = eventsClient.ping();
...
- `queues/ack_all.ts`: Demonstrates example of acknowledging the received message.
- `queues/batch.ts`: Demonstrates sending batch message in queue channels.
- `queues/dead-letter.ts`: Demonstrates sending message which will pushed to dead-letter-queue and then pulling back.
 - `queues/peek.ts`: Demonstrates getting message using peak and pull method.
...
- `queues/send-receive-message-stream.ts`: Demonstrates sending meesage using queue upstream and receive message using downstream.
...
#### Response:  `QueueMessageSendResult []` 
 ##### `QueueMessageSendResult` interface attributes
| Name       | Type            | Description                                                   |
|------------|-----------------|---------------------------------------------------------------|
| id         | String          | The unique identifier of the message.                         |
| sentAt     | LocalDateTime   | The timestamp when the message was sent.                      |
...
#### Response:  `QueueMessageSendResult` class attributes
| Name       | Type            | Description                                                   |
|------------|-----------------|---------------------------------------------------------------|
| id         | String          | The unique identifier of the message.                         |
| sentAt     | LocalDateTime   | The timestamp when the message was sent.                      |
...
#### Request:  `QueuesPullPeekMessagesRequest` class attributes
| Name                        | Type   | Description                                          | Default Value | Mandatory |
|-----------------------------|--------|------------------------------------------------------|---------------|-----------|
...
#### Response: `QueuesPullPeekMessagesResponse` class attributes 
| Name                  | Type                              | Description                                             |
|-----------------------|-----------------------------------|---------------------------------------------------------|
...
```typescript
ServerInfo pingResult = commandsClient.ping();
console.log('Ping Response: ' + pingResult);
