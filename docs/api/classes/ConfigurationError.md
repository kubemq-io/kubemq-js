...
[KubeMQ JS/TS SDK](../README.md) / ConfigurationError

# Class: ConfigurationError

Defined in: errors.ts:365
...
> **new ConfigurationError**(`options`): `ConfigurationError`

Defined in: errors.ts:368
...
> `readonly` **category**: `"Configuration"` = `ErrorCategory.Configuration`

Defined in: errors.ts:366
