...
[KubeMQ JS/TS SDK](../README.md) / BufferFullError

# Class: BufferFullError

Defined in: errors.ts:307
...
> **new BufferFullError**(`options`): `BufferFullError`
...
> `readonly` **category**: `"Backpressure"` = `ErrorCategory.Backpressure`
