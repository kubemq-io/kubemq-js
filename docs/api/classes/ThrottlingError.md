...
[KubeMQ JS/TS SDK](../README.md) / ThrottlingError
...
> **new ThrottlingError**(`options`): `ThrottlingError`
...
> `readonly` **category**: `"Throttling"` = `ErrorCategory.Throttling`

Defined in: errors.ts:252
