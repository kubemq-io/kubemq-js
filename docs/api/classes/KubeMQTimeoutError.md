...
[KubeMQ JS/TS SDK](../README.md) / KubeMQTimeoutError

# Class: KubeMQTimeoutError

Defined in: errors.ts:209
...
> **new KubeMQTimeoutError**(`options`): `KubeMQTimeoutError`
...
> `readonly` **category**: `"Timeout"` = `ErrorCategory.Timeout`

Defined in: errors.ts:210
