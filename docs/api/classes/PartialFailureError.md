...
[KubeMQ JS/TS SDK](../README.md) / PartialFailureError

# Class: PartialFailureError

Defined in: errors.ts:419
...
> **new PartialFailureError**(`options`): `PartialFailureError`

Defined in: errors.ts:422
...
> **error**: [`KubeMQError`](KubeMQError.md)
