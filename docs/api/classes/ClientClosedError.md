...
[KubeMQ JS/TS SDK](../README.md) / ClientClosedError

# Class: ClientClosedError

Defined in: errors.ts:337
...
> **new ClientClosedError**(`options`): `ClientClosedError`

Defined in: errors.ts:340
