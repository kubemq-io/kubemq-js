...
[KubeMQ JS/TS SDK](../README.md) / AuthenticationError
...
> **new AuthenticationError**(`options`): `AuthenticationError`
...
> `readonly` **category**: `"Authentication"` = `ErrorCategory.Authentication`
