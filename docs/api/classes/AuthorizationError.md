...
[KubeMQ JS/TS SDK](../README.md) / AuthorizationError

# Class: AuthorizationError

Defined in: errors.ts:195
...
> **new AuthorizationError**(`options`): `AuthorizationError`
...
> `readonly` **category**: `"Authorization"` = `ErrorCategory.Authorization`
