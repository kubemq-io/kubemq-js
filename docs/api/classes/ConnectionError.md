...
[KubeMQ JS/TS SDK](../README.md) / ConnectionError
...
- [`ConnectionNotReadyError`](ConnectionNotReadyError.md)

## Constructors

### Constructor

> **new ConnectionError**(`options`): `ConnectionError`

Defined in: errors.ts:170
