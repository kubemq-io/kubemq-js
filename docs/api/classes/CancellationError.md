...
[KubeMQ JS/TS SDK](../README.md) / CancellationError

# Class: CancellationError

Defined in: errors.ts:293
...
> **new CancellationError**(`options`): `CancellationError`

Defined in: errors.ts:296
...
> `readonly` **category**: `"Cancellation"` = `ErrorCategory.Cancellation`

Defined in: errors.ts:294
