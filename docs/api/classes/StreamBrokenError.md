...
[KubeMQ JS/TS SDK](../README.md) / StreamBrokenError

# Class: StreamBrokenError

Defined in: errors.ts:321
...
> **new StreamBrokenError**(`options`): `StreamBrokenError`

Defined in: errors.ts:325
